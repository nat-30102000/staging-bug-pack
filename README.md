...
- **Strict Validation**:
  - Export and Copy buttons are strictly disabled until all required fields are valid.
...
- **Instant Export Actions**:
  ...
  - **Reset Form**: Cleanly resets all inputs and state.
- **Privacy & Security**:
  - 100% client-side.
...
| **Validation blocks Export / Copy** | ✅ | Buttons are disabled and blocked until Title, Browser, OS, Expected, Actual, and 1+ step are filled. |
...
| **Exported Markdown Specification** | ✅ | Title as H1, Environment section, numbered steps, Expected, Actual, Screenshots section, and footer note `"Generated by staging-bug-pack"`. |
